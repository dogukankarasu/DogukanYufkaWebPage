...
<body style=" font-family:'Tangerine', 'serif'; color: #990000; ">
	...
	<h1 style="font-size:65pt"><img src="dy.png"  style="margin-right:120px; float: left; width: 250px; height: 150px;"/> DOĞUKAN YUFKA<img src="dy.png"  style=" float: right; width: 250px; height: 150px;"/></h1>
      ...
      <div id="hakkımızda" class="tabcontent">
			...
			<p>İşletmemiz 2008 yılında Ethem Karasu tarafından “DOĞUKAN YUFKA”  ismi ile Edirne/Keşan’da faliyete geçmiştir. 2008 yılından bu güne kaliteli ve temiz  hizmet anlayışı ile ürünlerini müşterilerine sunmaktadır. İşletmemiz, bünyesinde yufka haricinde ; mantı , erişte, yufka pilavı, siron, tarhana ,kuskus ve her gün düzenli olarak sıcak börek ve gözlemeleri ile hizmet vermektedir. Her yıl 1.5 ton yufka  ve 1.2 ton unlu mamuller kapasitesi ile sektörde en iyiler arasında yer almaktadır. Sadece Edirne ile sınırlı kalmayıp tüm Trakya ve Türkiye’nin her yerine ayrıca Yunanistan , Bulgaristan , Almanya gibi ülkere  ürünlerimizi sunmaktayız. .</p>
		</div>
